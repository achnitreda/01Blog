...
public class FollowResponse {
    ...
    public FollowResponse(String message, boolean isFollowing, Long followerId, String followerUsername,
    ...
    public static FollowResponse followSuccess(Long followerId, String followerUsername,
                                             Long followingId, String followingUsername) {
    ...
    public static FollowResponse unfollowSuccess(Long followerId, String followerUsername,
                                               Long followingId, String followingUsername) {
        return new FollowResponse(
